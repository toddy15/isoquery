...
public class Handle_3166_2 : Object {
    private static ProgramOptions options;
    private static ISO_3166_2 iso;
    ...
    private static void _show_item(ISO_3166_2_Item item) {
        stdout.printf("%s\t", item.country);
        stdout.printf("%s\t", item.type);
        stdout.printf("%s\t", item.code);
        stdout.printf("%s\t", item.parent);
